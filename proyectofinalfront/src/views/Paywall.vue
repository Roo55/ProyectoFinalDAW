<template>
    ...
    <div class="wrapper">
      <div class="payment">
        <div id="divFoto">
          <img src="../assets/img/kisspng-fitness-centre-logo-wall-decal-physical-fitness-cropped-jays-home-gym-png-logo-2-png-jayampapos-5c4f52c6431402.2105774115487024062748.png" alt="">
        </div>
        
        
        <h2>Completa el pago</h2>
        <p>Vas a pagar la subscripción mensual, {{ precio }} €</p>
        <div class="form">
   ...
   export default {
     setup() {
       ...
       const precio = computed(() => store.suscripcion.precio)
